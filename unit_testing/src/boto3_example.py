# Here we have changed 'add_dynamo_record' method's parameter (item: str) to (item: dict), as it take dict as an input for  testing..
...
class DynamodBExample(object):
    ...
    def add_dynamo_record(self, table_name: str, item: dict) -> None:
